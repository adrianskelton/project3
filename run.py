...
# This clears all the data in column A from the specified cells
clear_range = 'A13:A20'
empty_values = [['']] * 8  # Create an empty list with 8 rows
worksheet.update(clear_range, empty_values)  # Update the range with empty valuesplayername = ""
...
quiz_data = [
    ...
    {"question": "How big is the largest known ant colony?", 
     ...
     "answers": {"A": "3.7 miles",
                 ...
                 "C": "3700 miles",
		         "D": "37 miles"},
     "correct_answer": "C", "fact": "The largest recorded contiguous colony of ants in the world stretches 3,700 miles (6,000 kilometres) from northern Italy, through the south of France to the Atlantic coast of Spain, and is made up of a species of Argentine ant (Linepithema humile) introduced into Europe during the 1920s."},
    ...
    {"question": "How many times does a giant panda poop each day?", 
     ...
     "answers": {"A": "20",
                 ...
                 "C": "5",
		         "D": "40 times"},
     "correct_answer": "D", "fact": "The average daily diet of a giant panda consists of 20 to 30 lbs of bamboo. Given this voluminous diet, the giant panda defecates up to 40 times a day."},

    {"question": "What is the largest of the great apes?", 
         
     "answers": {"A": "Western lowland gorilla",
                 "B": "Eastern lowland gorilla",
                 "C": "Mountain gorilla",
		         "D": "Orangutang"},
     "correct_answer": "C", "fact": "Reaching an average height of 6 feet tall and weighing 400 to 500 pounds, the mountain gorilla is the largest of the great apes. Found only in the mountains of Rwanda, Zaire, and Uganda, mountain gorillas have been victimized by poaching as well as the destruction of much of their natural habitat. Like all other subspecies of gorilla, the mountain gorilla is considered an endangered species."},
    ...
    {"question": "What colour is spider blood?", 
     ...
     "answers": {"A": "Black",
                 ...
                 "C": "Yellow",
                 "D": "Red",},
     "correct_answer": "B", "fact": "In humans, oxygen is bound to hemoglobin, a molecule that contains iron and gives blood its red color. In spiders, oxygen is bound to hemocyanin, a molecule that contains copper rather than iron, making their blood blue."},
    print(score)
]
